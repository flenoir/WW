...
$day = utf8_encode(strftime("%A %d %B %Y", strtotime("+3 day")));
...
$current = $xmlmtp->xpath("/weather/dayf/day[@d='3']/part['p']/icon");
...
$current = $xml->xpath("/weather/dayf/day[@d='3']/part['p']/icon");
